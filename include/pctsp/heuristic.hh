...
getSubPathOverTour(std::list<Vertex> &tour, int index_of_first_vertex,
    ...
    cout << "Start vertex is " << sub_path.first_vertex;
...
std::list<Vertex> collapse(Graph &graph, std::list<Vertex> &tour,
    ...
    for (reverse_tour_iterator_t first_vertex_iterator = tour.rbegin();
        ...
        // vertex
        cout << ". Prize of path " << sub_path_over_tour.prize_of_path;
        cout << ". Feasibility vertex is "
             << sub_path_over_tour.feasibility_vertex;
        cout << ". Predecessor vertex is "
             << sub_path_over_tour.predecessor_vertex;
        cout << ". Root seen: " << sub_path_over_tour.root_vertex_seen;
        cout << ". Feasible path found: "
        ...
        if (sub_path_over_tour.root_vertex_seen &&
            ...
            for (Vertex collapse_vertex :
                ...
                if (edge_exists &
                    ...
                    cout << "Start at " << sub_path_over_tour.first_vertex;
                    cout << ". Predecessor at " << vertex_predecessor;
                    cout << ". Collapse at " << collapse_vertex;
                    cout << ". New cost is " << cost_of_new_tour;
                    cout << "(current best is " << cost_of_best_tour;
                    cout << "). New prize is " << prize_of_new_tour;
